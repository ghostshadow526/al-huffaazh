...
export default function NyeKogiStateHomePage() {
  return (
    <div className="space-y-16 pb-16">
      {/* Hero Section */}
      <section className="relative h-[60vh] bg-gray-800 text-white flex items-center justify-center">
        <Image
          src="https://picsum.photos/seed/nye-kogi-hero/1800/800"
          alt="Nye Kogi State Branch"
          fill
        ...
        <div className="grid md:grid-cols-2 gap-8">
            <Card className="hover:shadow-xl transition-shadow">
                ...
                <CardContent>
                    ...
                    <Button asChild>
                        <Link href="/branches/nye-kogi-state/about">Learn More</Link>
                    </Button>
                </CardContent>
            </Card>
            <Card className="hover:shadow-xl transition-shadow">
                ...
                <CardContent>
                    ...
                    <Button asChild>
                        <Link href="/branches/nye-kogi-state/gallery">View Gallery</Link>
                    </Button>
                </CardContent>
            </Card>
        </div>
