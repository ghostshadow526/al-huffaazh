      ...
      <section className="relative h-[60vh] bg-gray-800 text-white flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 space-y-4">
          <h1 className="text-4xl md:text-6xl font-bold font-headline">
            Welcome to AL-ASHED Branch
          </h1>
          <p className="text-lg md:text-xl max-w-3xl mx-auto">
            A center of excellence for Islamic and Western education.
          </p>
          <Button size="lg" asChild>
            <Link href="/branches/al-ashed/contact">Enroll Now</Link>
          </Button>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-8">
            <Card className="hover:shadow-xl transition-shadow">
                ...
                <CardContent>
                    ...
                    <Button asChild>
                        <Link href="/branches/al-ashed/about">Learn More</Link>
                    </Button>
                </CardContent>
            </Card>
            <Card className="hover:shadow-xl transition-shadow">
                ...
                <CardContent>
                    ...
                    <Button asChild>
                        <Link href="/branches/al-ashed/gallery">View Gallery</Link>
                    </Button>
                </CardContent>
            </Card>
        </div>
