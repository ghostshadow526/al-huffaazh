...
export default function LereGalleryPage() {
    const firestore = useFirestore();
    const branchSlug = 'lere-branch';
        ...
        <div className="bg-gray-50 py-16 md:py-24">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg text-gray-600 mt-2 font-body">Capturing moments at Lere Branch</p>
                </div>
