...
export default function ToroAboutPage() {
  return (
    <div className="bg-white py-16 md:py-24">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <Image 
                src="https://picsum.photos/seed/toro-about/600/400"
                alt="Students studying in Toro"
                width={600}
                height={400}
