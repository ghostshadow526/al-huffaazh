...
export default function JosDutseUkuHomePage() {
  return (
    <div className="space-y-16 pb-16">
      {/* Hero Section */}
      <section className="relative h-[60vh] bg-gray-800 text-white flex items-center justify-center">
        <Image
          src="https://picsum.photos/seed/jos-hero/1800/800"
          alt="JOS – Dutse Uku Branch"
          fill
        ...
        <div className="grid md:grid-cols-2 gap-8">
            <Card className="hover:shadow-xl transition-shadow">
                ...
                <CardContent>
                    ...
                    <Button asChild>
                        <Link href="/branches/jos-dutse-uku/about">Learn More</Link>
                    </Button>
                </CardContent>
            </Card>
            <Card className="hover:shadow-xl transition-shadow">
                ...
                <CardContent>
                    ...
                    <Button asChild>
                        <Link href="/branches/jos-dutse-uku/gallery">View Gallery</Link>
                    </Button>
                </CardContent>
            </Card>
        </div>
