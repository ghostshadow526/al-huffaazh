...
export default function KayardaAboutPage() {
  return (
    <div className="bg-white py-16 md:py-24">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <Image 
                src="https://picsum.photos/seed/kayarda-about/600/400"
                alt="Students studying in Kayarda"
                width={600}
                height={400}
