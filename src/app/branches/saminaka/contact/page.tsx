...
export default function SaminakaContactPage() {
  const branchAddress = "Saminaka, Kaduna State";
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="text-center">
                ...
                <CardContent>
                     <p className="text-muted-foreground">+234 123 456 7802</p>
                    <Button variant="link" asChild className="mt-2 text-primary-deep font-semibold">
                       <a href="tel:+2341234567802">Call Now</a>
                    </Button>
                </CardContent>
            </Card>
            <Card className="text-center">
                ...
                <CardContent>
                     <p className="text-muted-foreground break-all">saminaka@alhuffaazh.com</p>
                    <Button variant="link" asChild className="mt-2 text-primary-deep font-semibold">
                        <a href="mailto:saminaka@alhuffaazh.com">Send an Email</a>
                    </Button>
                </CardContent>
            </Card>
        </div>
