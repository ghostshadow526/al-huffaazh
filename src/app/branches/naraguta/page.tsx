        ...
        <div className="grid md:grid-cols-2 gap-8">
            <Card className="hover:shadow-xl transition-shadow">
                ...
                <CardContent>
                    ...
                    <Button asChild>
                        <Link href="/branches/naraguta/about">Learn More</Link>
                    </Button>
                </CardContent>
            </Card>
            <Card className="hover:shadow-xl transition-shadow">
                ...
                <CardContent>
                    ...
                    <Button asChild>
                        <Link href="/branches/naraguta/gallery">View Gallery</Link>
                    </Button>
                </CardContent>
            </Card>
        </div>
