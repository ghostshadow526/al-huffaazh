...
export default function NaragutaAboutPage() {
  return (
    <div className="bg-white py-16 md:py-24">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <Image 
                src="https://picsum.photos/seed/naraguta-about/600/400"
                alt="Students studying in Naraguta"
                width={600}
                height={400}
